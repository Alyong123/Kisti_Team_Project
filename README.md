...
<br>
전이 학습을 위해 사용한 **SSD-MobileNet-V2 FPNLite 640x640** 의 경우 탐지하는 객체가 다르기는 하였지만 실제 객체를 탐지하는 데에는 문제가 없었다. 
**SSD-MobileNet-V2 FPNLite 640x640** 모델 보다 **학습한 모델**의 결과 값이 더 높게 나왔기에 사용해도 좋다고 판단하였다.
